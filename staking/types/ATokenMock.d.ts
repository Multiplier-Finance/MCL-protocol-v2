...
export class ATokenMock extends Contract {
  ...
  functions: {
    _aic(overrides?: CallOverrides): Promise<{
      0: string;
    }>;
  ...
  estimateGas: {
    ...
    cleanUserState(overrides?: Overrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    cleanUserState(overrides?: Overrides): Promise<PopulatedTransaction>;
